...
class fedavg_api(object):
    ...
    def train(self):
        ...
        w_current = [w_global for _ in range(self.args.client_num_in_total)]
        ...
        for round_idx in comm_round_iterable:
            ...
            for cur_clnt in client_indexes:
                ...
                w_per = client.train(copy.deepcopy(w_global), w_current[cur_clnt], round_idx)
                w_current[cur_clnt] = copy.deepcopy(w_per)
